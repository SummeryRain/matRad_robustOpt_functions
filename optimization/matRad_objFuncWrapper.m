function f = matRad_objFuncWrapper(w,dij,cst,options, robustObjInfo)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            if isempty(strfind(cst{i,6}(j).type,'constraint'))
               ...
               % if conventional opt: just sum objectives of nominal dose
                if strcmp(cst{i,6}(j).robustness,'none')
                    ...
                    d_i = d{1}(cst{i,4}{1});    % The current dose in the region of interest.
                    ...
                    for roInd = 1:length(dROContainer)
                        ...
                        f = f + matRad_objFuncRobust(d_i,cst{i,6}(j),d_ref, min_worst, max_worst);
                    end
                end
